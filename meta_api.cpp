...
cvar_t tebex_showinfo = {"tebex_showinfo", "1", FCVAR_ARCHIVE | FCVAR_EXTDLL };
extern void InitPlugin( void );
...
plugin_info_t Plugin_info = {
	...
	"1.0",	// version
	"2018-10-03",	// date
	"Tebex <support@tebex.co.uk>",	// author
	"https://www.tebex.io",	// url
	"TEBEX",	// logtag, all caps please
